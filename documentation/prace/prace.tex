...
\fancyhead[C]{}
\fancyhead[L]{Maturitní práce -- \NazevSkoly}
\fancyhead[R]{Sudoku se vším všudy}
\fancyfoot[L]{Vypracoval: \AutorPrace}
\fancyfoot[C]{}
\fancyfoot[R]{\thepage}
}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\columnwidth]{../img/jigsawSections.png}
...
\subsection{Obchod}
Tabulka s obchodem obsahuje veškeré předměty, které lze zakoupit. Základ tabulky jsem získal z \footnote{\bibentry{reactTable}}. Na tom jsem provedl poměrně rozsáhlé úpravy. Aktuální funkcemi obchodu jsou vyhledávání na základě podobnosti s textem pomocí fuzzy finderu, stránkování dat a samozřejmě možnost nakoupit daný předmět.


\begin{figure}[H]
   \centering
   \includegraphics[width=0.8\textwidth]{../img/shop.jpg}
